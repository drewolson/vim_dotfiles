...
Plug 'junegunn/fzf', {'tag': '0.17.3', 'do': './install --bin'} | Plug 'junegunn/fzf.vim', {'commit': 'c0a5fee7071ed89602b9b59fb67e83d6cd23addc'}
...
let test#go#gotest#executable = 'vgo test'
